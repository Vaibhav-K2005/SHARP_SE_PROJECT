...
expiry rule, an SLA (Service Level Agreement) timer) can noticeably reduce unresolved cases and disputes.
...
\section{Summary}
This project proposes SHARP, a deployable web platform that integrates five disconnected hostel processes—leave and passes, mess feedback, room allotment, maintenance complaints, and laundry—into a single auditable system. The platform focuses on workflow correctness, traceability, scalability, and efficient process management. It supports phased implementation, CI/CD for frequent and reliable releases, and measurable performance through metrics such as complaint resolution time and SLA compliance.
